...
#Added by JackTheFlap
export PULSE_SERVER=tcp:localhost
export DISPLAY=localhost:0
#Defaults to C:/Users/*USER*/Documents/Scripts (in X11/VcXsrv), force change to home
cd ~

#ZSH if Bash = default shell
#if [ -t 1 ] && [ -f /home/j/zsh ]; then
#exec zsh
#fi

#Windows Folder Navigation (Will require drive letter moddifications)
alias C:='cd /mnt/c'
alias D:='cd /mnt/d'
